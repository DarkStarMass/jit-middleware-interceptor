...
- Do not add GitHub Actions, Codespaces, Spark, or any hosted runner. Tests run locally.

## How to work

1. Fork and branch from `main`.
2. Run `python -m unittest discover -s tests -v` **on your machine**.
...
There is no CI on this repository. A green local harness is the contract.
